...
namespace Tender.DataAccess.Migrations
{
    ...
    [Migration("20230611091342_changeTenderTblProperties")]
    partial class changeTenderTblProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tender.DataAccess.Models.SupplierPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TenderPaymentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tender.DataAccess.Models.SupplierPayment", b =>
                {
                    ...
                    b.HasOne("Tender.DataAccess.Models.TenderPayment", "TenderPayment")
                        .WithMany()
                        .HasForeignKey("TenderPaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Supplier");

                    b.Navigation("TenderPayment");
                });
